...
;; 19-Mar-96|$Revision: 1.1 $|~/packages/russian.el.Z

;; RCS $Id: russian.el,v 1.1 2006/06/01 03:51:35 ali Exp $
;; The revision number does NOT coincide with the version number.

;;; Change Log:
;; $Log: russian.el,v $
;; Revision 1.1  2006/06/01 03:51:35  ali
;; initial check-in
;;
...
(defconst russian-font-default-list
  '("ascii"  "ascii2" "7koi" "alt" "8koi" "mac" "cp1251" "osn"
...
(defconst russian-buffer-default-list
  '("ascii"  "ascii2" "7koi" "alt" "8koi" "mac" "cp1251" "osn" "gostcii"
...
(defconst russian-mode-default-list
  '("ascii" "7koi" "alt" "8koi" "mac" "cp1251" "osn" "gostcii"
    "naive" "libcon" "broken-8koi" "tex" "jcuken" "cp500" "ebcdic" "dkoi")
